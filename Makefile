...
MD5_OBJS=md5-c/md5.o
OBJS=main.o $(MD4C_OBJS) $(LUA_OBJS) $(MD5_OBJS)

LUA_CFLAGS=-DLUA_COMPAT_ALL -DLUA_USE_POSIX
CFLAGS=$(MYCFLAGS) -I lua -I md4c/src -I md5-c $(LUA_CFLAGS)
...
ldump.lua.h: ldump/init.lua
	echo "#define STRINGIFIED_LDUMP \\" > $@
	cat ldump/init.lua |sed -f stringify.sed >> $@

main.o: main.c main.lua.h etlua.lua.h ldump.lua.h
	$(CC) $(CFLAGS) -c main.c
